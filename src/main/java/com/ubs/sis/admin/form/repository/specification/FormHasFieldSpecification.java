...
import com.ubs.sis.admin.form.domain.custom_form.FormHasField;
import com.ubs.sis.admin.form.domain.custom_form.FormHasField_;
import com.ubs.sis.admin.form.domain.custom_form.Form_;
import org.springframework.data.jpa.domain.Specification;

import javax.persistence.criteria.Join;

public class FormHasFieldSpecification {


    public static Specification<FormHasField> withFormId(final Long id) {

        return (root, query, cb) -> {
            Join<FormHasField, Form> gateway = root.join(FormHasField_.form);
            return cb.equal(gateway.get(Form_.id), id);
        };
    }
